<script lang="ts" context="module">
	...
	import {ssrDirectiveAttributes} from '@agnos-ui/svelte-headless/utils/directive';
</script>
...
<script lang="ts">
	...
	const containerAttributes = ssrDirectiveAttributes(containerDirective);
</script>

<div use:containerDirective {...containerAttributes} class="d-inline-flex">
	<!-- on:blur={onTouched} ?? -->
